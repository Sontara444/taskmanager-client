...
import { CheckCircle2, Lock, Mail, User, ArrowRight, Layout } from 'lucide-react';
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8" style={{ backgroundColor: '#0a0b14' }}>
                <div className="w-full max-w-md space-y-8">
                    <div>
                        ...
                        <p className="text-gray-400">Join TaskFlow and start collaborating</p>
                    </div>
                    ...
                    <p className="text-center text-gray-500 text-sm">
                        ...
                        <Link to="/login" className="text-[#6366f1] hover:text-[#4f46e5] font-medium hover:underline">
                            Sign in
                        </Link>
                    </p>
                </div>
